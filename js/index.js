const RESOURCES = {
	"en-US": {
      ...
      UnitTestTraining: "Attended a training of \"Unit Testing Effectively with Legacy Code\" by Joey Chen @ Odd-e intended for improving development knowledge and skill.",
			MOSTProject: "[GSS] Customized Projects - Taiwan Ministry of Science and Technology (MOST) External & Internal System",
			MOSTProjectDetail: "A website system for public users such as professors & researchers submitting academic plans, while MOST internal users can manage data, review projects and assign tasks by this system.<br/>I applied knowledge of ASP.NET MVC in this project and learned more front-end knowledge during development. Assigned to introduce i18n because of familiarity of the projects. <br/>Supported 6 customized project in the series altogether.",
			I18nIntroducer: "The person responsible for introducing i18n",
			ODSystem: "[GSS] Product & Customized Project - Official Document System",
			ODSystemDetail: "A website system for organizations such as the Government departments, banks and large companies etc. processing official document online. Customized projects are derived from the product.<br/>I was assigned to support this product team by my supervisor after supporting MOST project. This system is one of the main product of our company which with more complex architecture and more scalability. Had more cooperation with project managers, system analysts and colleagues in this project. Had experience of discussing with the system designer and being authorized to debug in lower layer of projects as well.<br/>Supported original product team and 3 customized project teams derived from product.",
			...
			AJRepo: "[SOHO] Customized Project - Repository Management System",
			AJRepoDetail: "A website system for managing inventory information. This project involves issues such as Requirement Analysis / System Analysis / System Design / Database Schema Design / Website Development / Environment Building / Data Backup etc. In this case, I developed a solution of free automatic data backup with SQL Server Express, batch scripts and Google Drive.<br/>The first time to handle all process of system developing. And I noticed that traditional development methodology is not flexible enough to react to changes.",
	...
	"zh-TW": {
      ...
      TraineeOfUnitTestTraining: "「單元測試實戰操練營」課程學員",
			...
			MOSTProject: "叡揚資訊－台灣科技部內部與外部系統 [客製化專案]",
			...
			ODSystem: "叡揚資訊－公文系統 [自有產品與衍生客製化專案]",
...
function ReverseTimeline() {
  ...
  for (let i = 0; i < ResumeData.Experiences.length; i++) {
    let events = ResumeData.Experiences[i].Events;
    if(events) { events.reverse(); }
  }
  
  ResumeData.Experiences.reverse();
  ResumeData.Projects.reverse();
}
